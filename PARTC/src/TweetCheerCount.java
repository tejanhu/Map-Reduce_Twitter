...
public class TweetCheerCount {
  ...
  public static void runJob(String[] input, String output) throws Exception {
    ...
    job.setJarByClass(TweetCheerCount.class);
	 //mapper class is set
    job.setMapperClass(TweetCheerMapper.class);
	//reducer class is set
    job.setReducerClass(TweetCheerReducer.class);
